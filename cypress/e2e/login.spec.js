...
import LoginPage from '../pages/loginPage'
    ...
    Given("A web browser is at the telnyx login page {string}", (loginPageURL) => {
    ...
    Then("User sees the error message {string}", (Message) =>{
        LoginPage.errorMessage.should('be.visible').and('contains.text', Message)
    });
    ...
    Then("A user sees message {string}", (Message) =>{
        LoginPage.resetText.should('be.visible').and('contains.text', Message)
    });
    ...
    Then("A user sees error message at company name field {string}", (Message) =>{
        LoginPage.RequiredCompanyMessage.should('be.visible').and('contains.text', Message)
    });
    ...
    Then("A user sees the message {string}", (Message) =>{
        LoginPage.resendEmailMessage.should('be.visible').and('contains.text', Message)
    });
